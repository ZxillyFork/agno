...
When using `external_execution=True`, the agent can emit verbose paused-state
...
# external_execution_silent=True suppresses verbose paused-state messages
...
if __name__ == "__main__":
    ...
    """
    agent_os.serve(app="agent_with_silent_tools:app", port=7777, reload=True)
